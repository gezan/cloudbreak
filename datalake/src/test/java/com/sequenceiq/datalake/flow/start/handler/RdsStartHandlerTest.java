...
import com.sequenceiq.datalake.service.startstop.DatabaseStartStopSupportService;
...
public class RdsStartHandlerTest {
    ...
    @Mock
    private DatabaseStartStopSupportService databaseStartStopSupportService;
    ...
    public void shouldNotCallStartInCaseNoExternalDatabaseButSetStartedStatus() {
        when(databaseStartStopSupportService.supportsDatabaseStartStop(sdxCluster)).thenReturn(false);
    ...
    public void shouldCallStartInCaseExistingExternalDatabaseAndSetStartedStatus() {
        when(databaseStartStopSupportService.supportsDatabaseStartStop(sdxCluster)).thenReturn(true);
